package com.pockmarks.HEX.AI;

import com.pockmarks.HEX.UI.HexUI;
import com.pockmarks.HEX.action.GameAction;
import com.pockmarks.HEX.action.PlayerObject;
import com.pockmarks.HEX.action.PlayingEntity;
...
public class BeeGameAI implements PlayingEntity {
    ...
    private final LinkedList<AIHistoryObject> history = new LinkedList<AIHistoryObject>();//List of the AI's state. Used when Undo is called.
    ...
    private int evaluate() {
        ...
        lookUpTable.put(piecesString, Integer.valueOf(100 * (bluePotential - redPotential) - (blueMobility - redMobility)));
    ...
    @Override
    public void win() {
        System.out.println("AI赢");
    }

    @Override
    public void lose() {
        System.out.println("AI输");
    }
    ...
    public class AIHistoryObject {
        ...
        public AIHistoryObject(int[][] pieces, HashMap lookUpTable) {
            ...
            for (int i = 0; i < pieces.length; i++) {
                System.arraycopy(pieces[i], 0, this.pieces[i], 0, pieces.length);
            }
