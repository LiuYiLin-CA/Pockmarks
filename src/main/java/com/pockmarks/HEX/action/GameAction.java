...
import com.pockmarks.HEX.UI.AnyShapeButton;
...
public class GameAction {
    ...
    private static void setTeam(byte t, int x, int y, HexUI game) {
    ...
    public static boolean makeMove(PlayingEntity player, byte team, Point hex, HexUI game) {
